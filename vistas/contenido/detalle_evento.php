<main role="main">
  <section class="jumbotron text-center bg-light text-white bckgrnd-img" style="background-image: linear-gradient(#00000077, #000000bb), url('<?php echo $evento['thumbnail']; ?>');">
    <br><br><br><br>
    <div class="container">
      <h1 class="display-3"><?php echo $evento['nombre_evento']; ?></h1>
  ...
  <section class="container">
    <div class="row">
      <div class="col-12" style="margin: 0 auto; background-color: white; border-radius: 1rem; padding: 1.6rem 2.2rem; filter: drop-shadow(0 0.3rem 0.6rem #00000033);">
        <p class="text-secondary">DEL <b class="font-weight-bold mx-2"><?php echo $evento['fecha_inicio']; ?></b> AL <b class="font-weight-bold mx-2"><?php echo $evento['fecha_fin'] ?></b></p>
        <br>
        <h5 class="lead"><b class="badge badge-primary">Lugar</b> <?php echo $recinto['nombre_recinto']; ?></h5>
        <small><?php echo $recinto['direccion']; ?></small>
        <br>
        <br>
        <br>
        <h5 class="lead"><b class="badge badge-primary">Organizador</b> <?php echo $evento['organizador']; ?></h5>
        <br>
        <br>
        <h5 class="lead"><b class="badge badge-primary">Costo</b> <?php if($evento['costo'] == 0) {
          echo "Entrada libre";
        } else {
          echo "$" . $evento['costo'] . "<sup><mall>00</small></sup>";
        } ?></h5>
        <br>
        <br>
        <h5 class="lead"><b class="badge badge-primary">Tipo</b> <?php echo $evento['tipo']; ?></h5>
        <br>
        <br>
        <p class=""><?php echo $evento['descripcion']; ?></p>
      </div>
    </div>
  </section>
  ...
  <section class="container text-center">
    ...
    <form method="post" action="index.php?c=evento_controller&m=anadir_opinion&id_usuario=<?php if(isset($_SESSION['id_usuario']) && $_SESSION['id_usuario'] != '') { echo $_SESSION['id_usuario']; } else { echo '-1'; } ?>&id_evento=<?php echo $evento['id_evento'] ?>&recomendacion=5">
